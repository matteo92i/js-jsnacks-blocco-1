...
for(x = 0; x < 8; x++){
    ...
    let fusioneRandomico = listaNomi[nomiRandom] + ' ' + listaCognomi[cognomiRandom];
    listaUnita.push(fusioneRandomico);
    document.getElementById('lista-unita').innerHTML += '<li>' + fusioneRandomico + '</li>'
}
